# Headset Speaker AMA Application

## Overview
This app demonstrates the use of a Bluetooth&#174; Headset via the Bluetooth&#174; audio, AMA, and AAC libraries.

## Instructions
To demonstrate the app, follow these steps:

1. Build and download the application to the AIROC&#8482; board.
2. Press the pairing button to start pairing mode of the application.
3. Find and pair with the "HSAMA" Bluetooth&#174; audio device from your phone.
4. Once the pairing process is completed, stream music from your phone to the headset\_speaker\_ama app.
